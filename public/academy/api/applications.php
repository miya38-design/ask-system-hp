...
try {
    switch ($action) {
        ...
        case 'approve':
            ...
            // 保護者と生徒は別パスワード（子どもが保護者としてログインできないように）
...
※ログインID（メール）は共通ですが、パスワードは保護者・生徒で別々です。
　それぞれのパスワードでログインしてください（保護者用は保護者、生徒用は生徒としてログインします）。
※ログイン後、マイページからメールアドレス・パスワードを変更できます。
